            ...
            <form action="" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" name="allergies" rows="2" placeholder="List any allergies"><?php echo htmlspecialchars($patient['allergies']); ?></textarea>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Current Medications</label>
                        <textarea class="form-control" name="current_medications" rows="2" placeholder="List current medications"><?php echo htmlspecialchars($patient['current_medications']); ?></textarea>
                    </div>
                </div>
