...
try {
    ...
    if (!$dentist) {
        throw new Exception("Dentist profile not found");
    }
} catch (Exception $e) {
    $error = $e->getMessage();
}
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="profile.php" class="btn btn-secondary btn-sm"><i class="bi bi-arrow-left"></i> Back to Profile</a>
                    </div>
                </div>
                <div class="card-body">
                    <?php if ($error): ?>
